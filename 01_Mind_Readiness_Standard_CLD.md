---
name: mind-readiness-standard
description: Deterministic validation standard for deciding whether an Excel workbook is ready to upload into Milliman Mind. Use when auditing a Mind workbook, reviewing MMForExcel (MM_*) functions, checking grid/header structure, dynamic resize, input/export, instances, interlinks, or project settings, or when the user asks whether a workbook is "Mind Ready".
---
